...
@interface ViewController ()<THPreviewViewDelegate, CameraControllerDelegate>
...
-(void)showFace:(NSArray<__kindof AVMetadataObject *> *)faces {
    [self.previewView showFace:faces];
}
